...
description: A free, interactive Python course for complete beginners — write and run real Python in your browser, no setup. Built as the on-ramp to test automation, data, and AI.
prev: false
next: false
---
...
:::note[Where is my progress saved?]
Your XP and badges are stored **in this browser** — no sign-up, no password, no account. If you continue on another device, progress there starts fresh.
:::
...
Ready? [**Start with Module 0 →**](/en/python/00-foundations/what-is-programming/)

Prefer Azerbaijani? The course is also available in [**Azərbaycan dilində →**](/az/python/).

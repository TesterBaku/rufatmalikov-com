...
<Deck href="/python-sdet/decks/m7-pom/" title="Module 7: Page Object Model at a glance — slide guide" locale="en" />
...
The new line is `pythonpath = .` (it puts the project root on `sys.path`; it needs **pytest ≥

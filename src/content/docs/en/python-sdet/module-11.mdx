...
<Deck href="/python-sdet/decks/m11-capstone/" title="Module 11: the capstone suite at a glance — slide guide" locale="en" />
...
Want one more senior skill on top? [**Module 12 — Database verification**](/en/python-sdet/module-12/)
shows you how to prove an action *persisted* correctly by reading the database directly — the
"but did it actually save?" check that most suites, and most courses, skip.

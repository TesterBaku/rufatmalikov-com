...
Add a small `pytest.ini` to mark the project root and tell pytest where your tests live, so
`pytest` behaves the same no matter which folder you run it from:

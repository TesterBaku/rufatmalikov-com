...
small; Module 3 goes deep on API testing. The first one is the Module 0 smoke test, now
living in its own file alongside its siblings.
...
You already have the three tests from the worked example in `tests/test_products_api.py`. Add
two more to that file, exercising query params you haven't tried yet:

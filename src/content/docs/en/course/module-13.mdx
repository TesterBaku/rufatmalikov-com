...
The capstone application and the reference test framework live in their own repositories, separate from this course site.

| Repository | Link |
|---|---|
| Capstone application (TestMarket Lab) | [`capstone-app`](https://github.com/TesterBaku/) — _link coming soon_ |
| Reference test framework | [`capstone-tests`](https://github.com/TesterBaku/) — _link coming soon_ |

> These are placeholder links. The user will fill in the exact repository names once the repos are set up at `https://github.com/TesterBaku/`.
...
The app has a profile page at `/profile`. Add a page object for it.

...
Want one more senior skill on top? [**Module 14 — Database verification**](/en/course/module-14/)
...
[**SQL basics reference**](/en/reference/sql-basics/) covers the `SELECT` and `JOIN` queries it uses.

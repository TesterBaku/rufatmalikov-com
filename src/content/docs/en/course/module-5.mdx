...
:::note
`checkoutPage` here is a **page object** — a small helper class you'll build in Module 7. It's shown now only to contrast *where* each wait form belongs; you don't need to write one yet.
:::

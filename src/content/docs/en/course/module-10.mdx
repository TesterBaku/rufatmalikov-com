...
:::tip[Fuzzy on cookies, sessions, or `HttpOnly`?]
This module hinges on how a browser stays logged in. The **[Cookies & sessions reference](/en/reference/cookies-sessions/)** explains cookies, server-side sessions, `connect.sid`, and exactly why `storageState` *can* capture an `HttpOnly` cookie — the myth this module debunks.
:::

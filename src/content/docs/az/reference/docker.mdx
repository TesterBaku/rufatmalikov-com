...
Klik-klik vizual təlimat istəyirsən? Bu slayd bələdçisi Docker Desktop-u Windows-da başdan-sona quraşdırır — endirmə, WSL 2 seçimi və yoxlama addımı:

<Deck href="/course/decks/docker-install/" title="Docker quraşdırma — slayd təlimatı" />

...
Yekun layihənin tətbiqi və istinad test çərçivəsi bu kurs saytından ayrı öz repozitoriyalarında yerləşir.

| Repozitoriya | Link |
|---|---|
| Yekun layihə tətbiqi (TestMarket Lab) | [`capstone-app`](https://github.com/TesterBaku/) — _link tezliklə əlavə olunacaq_ |
| İstinad test çərçivəsi | [`capstone-tests`](https://github.com/TesterBaku/) — _link tezliklə əlavə olunacaq_ |

> Bunlar yer tutucu linklərdir. `https://github.com/TesterBaku/` ünvanında repolar qurulduqdan sonra istifadəçi dəqiq repozitoriya adlarını doldura bilər.
...
Tətbiqin `/profile` ünvanında profil səhifəsi var. Bunun üçün bir səhifə obyekti əlavə edin.

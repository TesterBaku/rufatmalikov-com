...
Bu üç aləti quraşdıracağıq. Hər addım aşağıdakı videoda da göstərilir — addımın yanındakı vaxt nişanına klikləyərək birbaşa həmin hissəyə keçə bilərsiniz.

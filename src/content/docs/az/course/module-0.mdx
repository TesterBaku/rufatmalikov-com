...
description: "Playwright kursunun ilk modulu: alət zəncirinizi qurun, ilk testinizi yazın və BrauzerLab-da məşqə başlayın."
pagefind: false
sidebar:
  hidden: true
---
...
Manual QA-da siz hər addımı öz başınızla düşünürsünüz: "Bu düyməyə basıram, bu mətn görünür, bu URL dəyişir." Avtomatlaşdırmada isə bu düşüncə prosesini kod şəklindəyazırsınız.
...
## BrauzerLab ilə ilk brauzer məşqi

İndi öyrəndiklərinizi praktikada tətbiq etməyin vaxtıdır. BrauzerLab-da `first-click` tapşırığı sizi Playwright-in ilk fundamental əməliyyatı ilə — bir elementə kliklə tanış edəcək.

Aşağıdakı linkə klikləyin, tapşırığı oxuyun və həll etməyə çalışın. Əgər ilişib qalsanız, ipucu düyməsindən istifadə edin.

<Practice missions={['first-click']} />

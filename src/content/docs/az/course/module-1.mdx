...
const testData = {
  ...
  validAdmin: {
    ...
    // email: 'admin@test.io', password: 'admin123', name: 'Test Admini'
  },
...
**Gözlənilən nəticə:**
```
Müştəri: { email: 'customer@test.io', password: 'customer123', name: 'Test Müştərisi' }
Admin: { email: 'admin@test.io', password: 'admin123', name: 'Test Admini' }
